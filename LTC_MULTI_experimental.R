...
run_ltc <- function(seed, max_clusters = 8, mcr = 0.5, savename = "exp_km_ab_ao.Rdata") {
  set.seed(seed)
  ...
  save(multiLTC, file = paste0(save_dir, savename))
